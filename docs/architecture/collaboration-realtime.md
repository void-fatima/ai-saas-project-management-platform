...
Mentions, sanitized rich text, attachment handling, subtask discussion UI, notification email/digest/deadline/preferences, account-wide security audit, chat, presence, coediting and advanced search/analytics remain in the roadmap. Workspace governance audit, AI assistance and deterministic reports are implemented in their separate contracts. None is implied by this milestone.
