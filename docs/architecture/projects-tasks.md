...
Drag-and-drop, richer positioning across pages, realtime, comments, notifications, AI, search, analytics, activity/audit infrastructure, priorities, labels, due dates, attachments, task history, milestones and project-specific membership remain preserved in the roadmap. They are not implemented by this slice.
